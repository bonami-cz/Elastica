...
class Query extends Param
{
    ...
    {
        trigger_error('Deprecated: \Bonami\Elastica\Query::setFilter() is deprecated. use Bonami\Elastica\Query::setPostFilter() instead.', E_USER_DEPRECATED);
    ...
    public function setPostFilter($filter)
    {
        if (!($filter instanceof AbstractFilter)) {
            trigger_error('Deprecated: \Bonami\Elastica\Query::setPostFilter() passing filter as array is deprecated. Pass instance of AbstractFilter instead.', E_USER_DEPRECATED);
        }
